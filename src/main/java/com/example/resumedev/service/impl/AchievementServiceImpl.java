...
public class AchievementServiceImpl implements AchievementService {
    ...
    public void deleteAchievement(Long achievementId, Long userId) {
        ...
        int achievementCount = getUserAchievementsCount(achievementId);
        ...
        if (achievementCount < 100) {
            awardRepository.deleteByTitleAndUserId(String.format("Награда за %d достижений", achievementCount), userId);
        }
    }
