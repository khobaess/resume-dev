...
import com.example.resumedev.service.impl.ResumeServiceImpl;
...
public class ResumeController {
    ...
    public ResponseEntity<InputStreamResource> exportToTxt(Long userId) throws Exception {
        ...
        String txtContent = resumeServiceImpl.resumeGenerateTxt(userId);
    ...
    public ResponseEntity<Page<ResumeDto>> getResumes(
        ...
        return ResponseEntity.ok(resumeServiceImpl.getResumes(userId,  pageable));
    }
    ...
    public ResponseEntity<ResumeDto> getResume(
        ...
        ResumeDto resume = resumeServiceImpl.getResume(id, userId, achievementId);
    ...
    public ResponseEntity<ResumeDto> createResume(
        ...
        ResumeDto createdResume = resumeServiceImpl.createResume(resumeDto.getUserId(), resumeDto.getAchievementId(), resumeDto);
    ...
    public ResponseEntity<Void> deleteResume(
        ...
        resumeServiceImpl.deleteResume(id, userId, achievementId );
